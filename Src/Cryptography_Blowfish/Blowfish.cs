namespace Cryptography_Blowfish
{
    ...
    public class BlowfishCBC : BlowfishECB
    {
        ...
        /// </summary>
        /// <param name="buf">buffer to copy the IV to</param>
        /// <param name="nOfs">where to start copying</param>
        public void GetIV(
            byte[] buf,
            int nOfs)
        {
        ...
        /// </summary>
        /// <param name="buf">buffer containing the new IV material</param>
        /// <param name="nOfs">where the IV material starts</param>
        public void SetIV(
            byte[] buf,
            int nOfs)
        {
    ...
    public class BlowfishECB : ICloneable
    {
        ...
        /// <param name="unOutHi">where to put the decrypted high word</param>
        /// <param name="unOutLo">where to put the decrypted low word</param>
